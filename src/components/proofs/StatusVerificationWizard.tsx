...
const credentialSchema = z.custom<File>(
  (value) => {
...
const steps = [
  {
    ...
    description:
      "Choose the status you wish to confirm, such as student, volunteer, or cooperative member.",
    icon: Users,
  },
  {
    id: 2,
    ...
    description:
      "Provide a secure scan of your ID, institutional letter, or partner-issued QR.",
    icon: FileSearch,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Upon success, you receive governance weight and access to council proposals.",
    icon: ShieldCheck,
  },
];
...
export function StatusVerificationWizard() {
  ...
  return (
    <div className="space-y-6">
        ...
        {steps.map((step) => {
          ...
          return (
            ...
            >
              ...
              {isCompleted && (
                <CheckCircle2 className="mt-3 h-5 w-5 text-green-500" />
              )}
            </li>
          );
        })}
      ...
      <form
        onSubmit={onSubmit}
        className="space-y-5 rounded-3xl border border-neutral-200/80 bg-white/90 p-6 shadow-sm dark:border-neutral-800/80 dark:bg-neutral-900/60"
      >
        {currentStep === 1 && (
            ...
            render={({ field }) => (
              <div className="space-y-2">
                ...
                {form.formState.errors.credentialFile && (
                  <p className="text-xs text-red-500">
                    {form.formState.errors.credentialFile.message}
                  </p>
                )}
              </div>
            )}
        ...
        {currentStep === 3 && (
          <div className="space-y-2">
            <label className="text-sm font-medium text-neutral-700 dark:text-neutral-200">
              Reference or partner code (optional)
            </label>
            <input
            ...
            />
            <p className="text-xs text-neutral-500 dark:text-neutral-400">
              Enter a code issued by your institution to speed up AI
              verification.
            </p>
          </div>
        )}
          ...
          <div>
            ...
            {mutation.isSuccess && (
              <p className="text-sm text-green-600 dark:text-green-300">
                Status review submitted. Governance eligibility only changes
                after review and any future protocol mirror confirms the result.
              </p>
            )}
          </div>
