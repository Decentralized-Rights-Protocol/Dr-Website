...
const activityFileSchema = z.custom<File>(
  (value) => {
...
const activitySchema = z.object({
  ...
  description: z
    .string()
    .min(20, "Share at least 20 characters about the activity"),
  ...
  const submissionState = useMemo(() => {
    if (mutation.isSuccess) {
      return {
        ...
        message:
          "Your proof is now in the Convex review queue. Protocol mirroring happens separately and is not implied by this submission.",
      };
    }
    if (mutation.isError) {
      return {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
            ...
            >
              ...
              <div className="text-center text-sm">
                <p className="font-medium">
                  Drop your evidence or browse files
                </p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400">
                  Images (JPG/PNG) or videos (MP4) up to 25MB.
                </p>
              </div>
              <input
                type="file"
      ...
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary-600 to-primary-500 px-6 py-3 text-sm font-semibold text-foreground shadow-md transition hover:-translate-y-0.5 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-70"
      >
