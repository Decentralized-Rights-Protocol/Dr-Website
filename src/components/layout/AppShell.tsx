      ...
      <header className="sticky top-0 z-50 border-b border-neutral-200/80 bg-white/80 backdrop-blur-xl dark:border-neutral-800/50 dark:bg-drp-dark/80">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="hidden sm:block">
              <p className="text-lg font-bold tracking-tight text-neutral-900 dark:text-foreground">
                DRP
              </p>
        ...
        {isMobileNavOpen && (
          <div
            ...
            className="animate-fade-in border-t border-neutral-200 bg-white/95 px-4 py-6 backdrop-blur-lg dark:border-neutral-800 dark:bg-drp-dark/95 md:hidden"
          >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-bold text-neutral-900 dark:text-foreground">
                  DRP
                </p>
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <div className="flex flex-col gap-3">
                <p className="text-sm font-bold uppercase tracking-wider text-neutral-900 dark:text-foreground">
                  Platform
                </p>
                <Link
                  href="/dashboard"
                  className="text-sm text-neutral-500 hover:text-drp-blue dark:text-neutral-400"
                >
                  Dashboard
                </Link>
                <Link
          ...
          <div className="mt-12 flex flex-col items-center justify-between border-t border-neutral-200 pt-8 dark:border-neutral-800 sm:flex-row">
            ...
            <div className="mt-4 flex gap-6 sm:mt-0">
              <a
                href="https://x.com/drp"
                className="text-neutral-400 hover:text-drp-blue transition-colors"
                target="_blank"
                rel="noreferrer"
              >
