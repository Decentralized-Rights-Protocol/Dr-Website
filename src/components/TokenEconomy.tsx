  ...
  const mechanics = [
    {
      ...
      description:
        "Stake $RIGHTS tokens to earn rewards and participate in governance decisions.",
    },
    {
      icon: "fas fa-chart-line",
      title: "Deflationary Model",
      description:
        "Built-in burn mechanisms reduce token supply over time, increasing scarcity.",
    },
    {
      icon: "fas fa-balance-scale",
      title: "Governance",
      description:
        "Token holders vote on platform upgrades, funding decisions, and policy changes.",
    },
    {
      icon: "fas fa-hand-holding-heart",
      title: "Impact Rewards",
      description:
        "Earn $DeRi tokens by contributing to human rights initiatives and community building.",
    },
  ];
          ...
          {tokenCards.map((token, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-primary font-medium mb-6">{token.symbol}</p>
                ...
                <div className="space-y-3 mb-8">
                  {token.features.map((feature, featureIndex) => (
                    <div
                      key={featureIndex}
                      className="flex items-center gap-3 p-3 bg-darker-bg border border-border-color rounded-lg"
                    >
                ...
                <div className="space-y-3">
                  {token.stats.map((stat, statIndex) => (
                    <div
                      key={statIndex}
                      className="flex justify-between items-center p-3 bg-darker-bg border border-border-color rounded-lg"
                    >
