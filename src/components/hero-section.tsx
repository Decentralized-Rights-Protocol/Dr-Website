...
const features = [
  {
    ...
    description:
      "Advanced cryptography protecting human rights data from future threats",
  },
  {
    icon: Users,
    title: "Community Governance",
    description:
      "Decentralized decision-making ensuring protocol serves global needs",
  },
  {
    icon: Globe,
    title: "Global Impact",
    description:
      "Cross-border solutions working across cultures and legal systems",
  },
  {
    icon: Zap,
    title: "Real-time Verification",
    description:
      "Instant verification and documentation of human rights violations",
  },
];
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="animate-fade-in-up mt-6 space-y-3 text-lg leading-8 text-foreground/70 delay-200">
            <p className="font-medium">
              ...
              platform that protects human rights through AI-verified consensus
              mechanisms. DRP uses Proof of Status (PoST) for identity
              verification and Proof of Activity (PoAT) to reward real-world
              contributions, creating a sustainable, human-rights-centered
              blockchain ecosystem.
            </p>
            <p>
              Built with NIST-approved post-quantum cryptography (CRYSTALS-Kyber
              and CRYSTALS-Dilithium), DRP ensures long-term security against
              quantum computing threats while prioritizing human dignity,
              environmental responsibility, and transparent governance.
            </p>
          </div>
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
            {features.map((feature, index) => (
              <div
                key={feature.title}
                className="group relative animate-fade-in-up rounded-2xl border border-border bg-card p-6 shadow-lg backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-primary"
              ...
              >
                <dt className="mb-3 flex items-center gap-x-3 text-base font-semibold leading-7 text-card-foreground">
                  <div className="rounded-xl p-3 bg-accent/20 group-hover:bg-accent/30 group-hover:shadow-lg transition-all duration-300">
                    <feature.icon
                      className="h-6 w-6 flex-none text-primary transition-all duration-300 group-hover:scale-110"
                      aria-hidden="true"
                    />
                  </div>
                  {feature.title}
