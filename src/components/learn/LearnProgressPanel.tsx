...
const modules = [
  {
    moduleSlug: "digital-rights-foundations",
    lessonSlug: "rights-charter-basics",
    title: "Digital Rights Foundations",
    xp: 35,
  },
  {
    moduleSlug: "sustainability-human-rights",
    lessonSlug: "sustainability-and-rights",
    title: "Sustainability & Human Rights",
    xp: 28,
  },
  {
    moduleSlug: "community-verification-labs",
    lessonSlug: "community-verification-labs",
...
export function LearnProgressPanel({ walletAddress }: LearnProgressPanelProps) {
  ...
  const progressMap = new Map<string, any>(
    (progress ?? []).map((entry: any) => [entry.lessonSlug, entry]),
  );
      ...
      {modules.map((module) => {
        ...
        return (
          <article
            ...
            className="rounded-3xl border border-neutral-200/70 bg-white/80 p-5 shadow-sm dark:border-neutral-800/70 dark:bg-neutral-900/60"
          >
            ...
            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
              Reward target: {module.xp} XP-equivalent app points.
            </p>
