  ...
  return (
    <svg viewBox="0 0 500 500" className="w-full h-auto max-w-sm">
      ...
      <text
        ...
        y="265"
        textAnchor="middle"
        className="text-[10px] fill-drp-cyan font-cinematic uppercase tracking-widest"
      >
        Core
      </text>
      ...
      <g>
        ...
        <text
          ...
          y="50"
          textAnchor="middle"
          className="text-[9px] fill-foreground font-bold uppercase"
        >
          Activity
        </text>
      </g>
  ...
  return (
    <svg viewBox="0 0 600 420" className="w-full h-auto max-w-3xl">
      ...
      <text
        ...
        y="82"
        textAnchor="middle"
        className="text-[16px] fill-foreground font-black uppercase tracking-[0.2em]"
      >
        Application Layer
      </text>
  ...
  return (
    <svg viewBox="0 0 640 400" className="w-full h-auto max-w-3xl">
      ...
      <text
        ...
        y="215"
        textAnchor="middle"
        className="text-[10px] fill-drp-gray font-cinematic uppercase tracking-widest"
      >
        Input
      </text>
      ...
      <text
        ...
        y="215"
        textAnchor="middle"
        className="text-[10px] fill-emerald-400 font-cinematic uppercase tracking-widest"
      >
        Outcome
      </text>
      ...
      <line
        ...
        strokeWidth="3"
        strokeDasharray="8,4"
        markerEnd="url(#econArrow)"
      />
      <text
        x="320"
        y="185"
        textAnchor="middle"
        className="text-[11px] fill-emerald-400 font-bold uppercase tracking-widest"
      >
        Protocol Value
      </text>
      ...
      <text
        ...
        y="340"
        textAnchor="middle"
        className="text-[10px] fill-amber-400/60 font-cinematic uppercase tracking-widest"
      >
        Staking & Governance
      </text>
    </svg>
  ...
  return (
    <svg viewBox="0 0 600 400" className="w-full h-auto max-w-3xl">
      ...
      <text
        ...
        y="90"
        textAnchor="middle"
        className="text-[18px] fill-foreground font-black tracking-tight"
      >
        ELDER QUORUM
      </text>
      <text
        ...
        y="115"
        textAnchor="middle"
        className="text-[9px] fill-drp-gray font-cinematic uppercase tracking-[0.3em]"
      >
        Governance Hub
      </text>
      ...
      <g transform="translate(80, 240)">
        ...
        <text
          ...
          y="55"
          textAnchor="middle"
          className="text-[9px] fill-drp-gray font-cinematic uppercase tracking-widest"
        >
          Initiation
        </text>
      </g>
  ...
  return (
    <svg viewBox="0 0 600 400" className="w-full h-auto max-w-3xl">
      ...
      <text
        ...
        y="195"
        textAnchor="middle"
        className="text-[14px] fill-foreground font-black tracking-widest uppercase"
      >
        Consensus
      </text>
      <text
        ...
        y="215"
        textAnchor="middle"
        className="text-[9px] fill-drp-cyan font-cinematic uppercase tracking-widest"
      >
        Verified
      </text>
