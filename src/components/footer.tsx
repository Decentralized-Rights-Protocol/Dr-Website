        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10">
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-5 group">
              ...
              />
              <span className="font-bold tracking-widest text-xs uppercase text-foreground">
                DRP
              </span>
            </Link>
            ...
            <div className="group block mb-2">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] text-foreground/25 uppercase tracking-widest transition-colors">
                  One Planet
                </span>
              </div>
            </div>
          ...
          {cols.map((col) => (
            <div key={col.title}>
              <h4 className="text-xs font-bold tracking-widest uppercase text-foreground/30 mb-5">
                {col.title}
              </h4>
      ...
      <div className="border-t border-foreground/5">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-foreground/25">
            © {new Date().getFullYear()} Decentralized Rights Protocol. Human
            Rights Infrastructure for the AI Age.
          </p>
          <div className="flex items-center gap-6 text-xs text-foreground/25">
            ...
            <Link
              href="/status"
              className="hover:text-[#00e5cc] transition-colors flex items-center gap-1.5"
            >
