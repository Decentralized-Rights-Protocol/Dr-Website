    ...
    <div className="grid gap-6 lg:grid-cols-2">
      <div className="rounded-3xl border border-neutral-200/80 bg-white/80 p-6 shadow-sm dark:border-neutral-800/80 dark:bg-neutral-900/60">
        ...
        <p className="mb-4 text-sm text-neutral-500 dark:text-neutral-400">
          Track your verified Proof of Activities alongside monthly reward
          issuance.
        </p>
      ...
      <div className="rounded-3xl border border-neutral-200/80 bg-white/80 p-6 shadow-sm dark:border-neutral-800/80 dark:bg-neutral-900/60">
        ...
        <p className="mb-4 text-sm text-neutral-500 dark:text-neutral-400">
          Understand how your verified efforts translated into DeRi utility
          credits, RIGHTS governance weight, and sustainability boosts.
        </p>
        <div className="h-64 w-full">
          <ResponsiveContainer>
