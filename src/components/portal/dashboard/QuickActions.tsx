...
const actions = [
  ...
  },
  {
    ...
    description:
      "Monitor the live DRP ledger, blocks, and reality layer transactions.",
    icon: Scan,
  },
  {
    href: "/rewards",
      ...
      <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Your most-used flows, arranged for rapid stewardship.
          </p>
        </div>
        <Link
          href="/dashboard"
          className="text-sm font-semibold text-primary-600 hover:text-primary-500 dark:text-primary-300"
        >
          Open full dashboard →
        </Link>
      </header>
