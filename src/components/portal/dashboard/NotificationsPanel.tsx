      ...
      <header className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Reviews, governance, and learning updates.
          </p>
        </div>
      </header>
        ...
        <ul className="mt-4 space-y-3">
          {notifications.slice(0, 5).map((notification: any) => (
            <li
              ...
              className="rounded-2xl border border-neutral-200/70 bg-neutral-50/70 p-4 dark:border-neutral-800/70 dark:bg-neutral-950/30"
            >
              ...
              <div className="mt-2 flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400">
                ...
                {notification.href ? (
                  <a
                    ...
                    className="inline-flex items-center gap-1 text-primary-600 dark:text-primary-300"
                  >
                    Open
