...
const values = [
  {
    name: "Transparency",
    description:
      "Open-source technology and transparent governance processes that anyone can verify and participate in.",
    icon: Eye,
  },
  {
    name: "Security",
    description:
      "Quantum-safe cryptography and robust security measures to protect sensitive human rights data.",
    icon: Shield,
  },
  {
    name: "Humanity",
    description:
      "Every decision is guided by our commitment to protecting and advancing human rights globally.",
    icon: Heart,
  },
  {
    name: "Community",
    description:
      "Decentralized governance ensuring that the protocol serves the needs of human rights defenders worldwide.",
    icon: Users,
  },
];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:max-w-none">
          ...
          <p className="mt-4 text-lg leading-8 text-neutral-300 animate-fade-in-up delay-200">
            To create a decentralized, transparent, and secure platform that
            protects, verifies, and advances human rights globally through
          ...
          {values.map((value, index) => (
            ...
            >
              <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-foreground group-hover:text-primary-400 transition-colors">
                <value.icon
                  className="h-5 w-5 flex-none text-primary-400 group-hover:text-primary-300 transition-colors"
                  aria-hidden="true"
                />
                {value.name}
              </dt>
