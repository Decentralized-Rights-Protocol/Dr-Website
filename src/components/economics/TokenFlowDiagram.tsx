          ...
          {flows.map((flow, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-2">
                <div
                  className={`p-4 rounded-xl bg-gradient-to-br ${flow.from.color} to-blue-600`}
                >
              ...
              <div className="flex flex-col items-center gap-2">
                <div
                  className={`p-4 rounded-xl bg-gradient-to-br ${flow.to.color} to-purple-600`}
                >
