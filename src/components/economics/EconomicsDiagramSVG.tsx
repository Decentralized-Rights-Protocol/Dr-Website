...
export function EconomicsDiagramSVG({
  type,
  className = "",
  delay = 0,
}: EconomicsDiagramSVGProps) {
  const renderDiagram = () => {
    switch (type) {
      case "supply-demand":
  ...
  return (
    <svg viewBox="0 0 700 500" className="w-full h-auto">
      ...
      <text
        ...
        y="30"
        textAnchor="middle"
        className="text-lg fill-neutral-900 dark:fill-white font-bold"
      >
      ...
      <text
        ...
        y="440"
        textAnchor="middle"
        className="text-sm fill-neutral-700 dark:fill-neutral-300 font-semibold"
      >
      ...
      <text
        x="570"
        y="360"
        className="text-sm fill-green-600 dark:fill-green-400 font-semibold"
      >
        D (Utility-Driven)
      </text>
      ...
      <g transform="translate(200, 120)">
        ...
        <text
          ...
          y="5"
          textAnchor="middle"
          className="text-xs fill-green-700 dark:fill-green-300 font-medium"
        >
          D = f(Utility, Network)
        </text>
      </g>
      ...
      <text
        x="360"
        y="245"
        className="text-sm fill-amber-700 dark:fill-amber-300 font-bold"
      >
        E*
      </text>
      <text
      ...
      <g transform="translate(80, 50)">
        <rect
          ...
          stroke="#f59e0b"
          strokeWidth="2"
          className="dark:fill-amber-950/30 dark:stroke-amber-700"
        />
        <text
          x="270"
          y="15"
          textAnchor="middle"
          className="text-xs fill-amber-900 dark:fill-amber-200 font-semibold"
        >
          Key Insight: Supply shifts with verified activity, not fixed like
          traditional markets
        </text>
        <text
          x="270"
          y="30"
          textAnchor="middle"
          className="text-xs fill-amber-800 dark:fill-amber-300"
        >
          More activity → Supply curve shifts right → Lower equilibrium price
          (if demand constant)
        </text>
      </g>
    </svg>
    ...
    <svg viewBox="0 0 800 600" className="w-full h-auto">
      ...
      <g transform="translate(400, 100)">
        ...
        <text
          ...
          y="0"
          textAnchor="middle"
          className="text-base fill-blue-700 dark:fill-blue-300 font-semibold"
        >
          Verified Activity
        </text>
        <text
        ...
        <text
          ...
          y="75"
          textAnchor="middle"
          className="text-base fill-purple-700 dark:fill-purple-300 font-semibold"
        >
          Money Supply (M)
        </text>
        <text
        ...
        <text
          ...
          y="75"
          textAnchor="middle"
          className="text-base fill-green-700 dark:fill-green-300 font-semibold"
        >
          Velocity (V)
        </text>
        <text
        ...
        <text
          x="265"
          y="130"
          className="text-xs fill-green-600 dark:fill-green-400 font-medium"
        >
          Measured
        </text>
        ...
        <text
          ...
          y="175"
          textAnchor="middle"
          className="text-base fill-cyan-700 dark:fill-cyan-300 font-semibold"
        >
          Price Level (P)
        </text>
        <text
          ...
          y="190"
          textAnchor="middle"
          className="text-xs fill-cyan-600 dark:fill-cyan-400"
        >
          M × V = P × Y
        </text>
        ...
        <text
          x="-30"
          y="300"
          className="text-xs fill-amber-600 dark:fill-amber-400 font-medium"
        >
          If P ↑
        </text>
        ...
        <text
          ...
          y="375"
          textAnchor="middle"
          className="text-base fill-amber-700 dark:fill-amber-300 font-semibold"
        >
          Quiz Friction
        </text>
        <text
    ...
    <svg viewBox="0 0 600 400" className="w-full h-auto">
      ...
      <g transform="translate(150, 100)">
        ...
        <text
          ...
          y="-5"
          textAnchor="middle"
          className="text-sm fill-blue-700 dark:fill-blue-300 font-bold"
        >
          $DeRi
        </text>
        <text
      ...
      <text
        ...
        y="95"
        textAnchor="middle"
        className="text-sm fill-green-700 dark:fill-green-300 font-semibold"
      >
        Activity
      </text>
      <text
      ...
      <g transform="translate(450, 100)">
        ...
        <text
          ...
          y="-5"
          textAnchor="middle"
          className="text-sm fill-purple-700 dark:fill-purple-300 font-bold"
        >
          $RIGHTS
        </text>
        <text
      ...
      <g transform="translate(300, 250)">
        ...
        <text
          ...
          y="0"
          textAnchor="middle"
          className="text-sm fill-amber-700 dark:fill-amber-300 font-semibold"
        >
          Activity Credits
        </text>
        <text
      ...
      <text
        ...
        y="30"
        textAnchor="middle"
        className="text-base fill-neutral-900 dark:fill-white font-bold"
      >
    ...
    <svg viewBox="0 0 700 300" className="w-full h-auto">
      ...
      <g transform="translate(100, 150)">
        ...
        <text
          ...
          y="-10"
          textAnchor="middle"
          className="text-sm fill-blue-700 dark:fill-blue-300 font-semibold"
        >
          Activity
        </text>
        <text
