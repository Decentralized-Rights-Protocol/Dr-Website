...
const comparisonData: ComparisonData[] = [
  ...
  },
  {
    ...
    isDrpAdvantage: true,
    details:
      "DRP uses NIST-approved post-quantum cryptographic algorithms (CRYSTALS-Kyber for key encapsulation and CRYSTALS-Dilithium for digital signatures) to protect against both classical and quantum computer attacks. This ensures long-term security even as quantum computing technology advances, future-proofing the protocol.",
  },
  {
    feature: "Data Layer",
    bitcoin: "Chain Only",
            ...
            {comparisonData.map((row, index) => (
              <React.Fragment key={row.feature}>
                ...
                {expandedFeature === row.feature && row.details && (
                  <tr>
                    <td
                      colSpan={blockchains.length + 1}
                      className="px-6 py-4 bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-700"
                    >
          ...
          >
            ...
            <div className="space-y-2">
              {blockchains.map((blockchain) => (
                ...
                >
                  <span className={cn("font-medium text-sm", blockchain.color)}>
                    {blockchain.name}
                  </span>
                  <span
                    className={cn(
