      ...
      <div className="mx-auto max-w-5xl px-4 pb-20">
        ...
        <PremiumSection eyebrow="Architecture" title="Hash-Based Cryptography">
          ...
          <div className="space-y-4 mt-6">
            <div className="rounded-lg border border-foreground/10 bg-black/30 p-5">
        ...
        <PremiumSection eyebrow="Governance Security" title="AI ElderCore Governance">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            <div className="rounded-lg border border-foreground/10 bg-black/30 p-6">
        ...
        <section className="rounded-2xl border border-cyan-300/20 bg-gradient-to-r from-cyan-300/15 via-blue-300/10 to-indigo-300/10 p-8 text-foreground">
