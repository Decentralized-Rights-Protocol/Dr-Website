        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-neutral-300 mb-6">
              AI Elders are specialized AI systems tasked with monitoring the
              integrity of the DRP economy— not to control humans, but to
              protect them. They:
            </p>
            <ul className="space-y-3 text-neutral-700 dark:text-neutral-200">
              <li>
                • Monitor asset flows for signs of corruption, exploitation, or
                systemic bias
              </li>
              <li>• Flag anomalies and potential abuses for human review</li>
              <li>
                • Enforce rights constraints (no one falls below basic rights
                thresholds)
              </li>
              <li>
                • Provide transparent, explainable reports to communities and
                institutions
              </li>
            </ul>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="p-6 rounded-xl bg-transparent-800 border border-neutral-200 dark:border-neutral-700">
                ...
                <p className="text-neutral-300">
                  Encodes verified credentials (education, professional status,
                  institutional recognition) without exposing private data. Used
                  for governance weighting and access control.
                </p>
              </div>
              <div className="p-6 rounded-xl bg-transparent-800 border border-neutral-200 dark:border-neutral-700">
                <h3 className="text-xl font-bold text-foreground mb-3">
                ...
                <p className="text-neutral-300">
                  Records verified human activity (work, learning, civic
                  engagement) to inform rewards, representation, and
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="p-6 rounded-xl bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700">
                ...
                <p className="text-neutral-300">
                  Using rights-backed identity and multi-chain attestations, DRP
                  can recover lost assets when users lose keys, subject to
                  strict governance and community oversight.
                </p>
              </div>
              <div className="p-6 rounded-xl bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700">
                <h3 className="text-xl font-bold text-foreground mb-3">
                ...
                <p className="text-neutral-300">
                  Whistleblowers and vulnerable individuals can report abuse or
                  corruption anonymously. AI Elders triage reports, and human
                  councils adjudicate using transparent, rights-based norms.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-to-b from-neutral-50 to-white dark:from-neutral-800 dark:to-neutral-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-neutral-300 mb-6">
              Every governance decision in DRP is evaluated against a rights
              charter inspired by global human rights frameworks and adapted for
              decentralized contexts.
            </p>
            <ul className="space-y-3 text-neutral-700 dark:text-neutral-200">
              <li>• No decision may violate basic human rights baselines</li>
              <li>
                • All major decisions are recorded on-chain with public
                rationales
              </li>
              <li>• Minority protections prevent tyranny of the majority</li>
              <li>
                • Impact assessments evaluate effects on human development and
                sustainability
              </li>
            </ul>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Explore the DRP explorer to see how governance, activity, and
              distribution appear on-chain.
            </p>
            <Link
              href="/explorer"
