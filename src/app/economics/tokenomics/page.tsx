        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-300 mb-8">
              DRP uses two complementary tokens to separate governance from
              utility, ensuring both rights protection and economic activity are
          ...
          >
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-lg text-neutral-300 mb-6">
                DRP tokens are distributed through a fair launch mechanism that
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                >
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br ${item.color} mb-4`}
                  >
                    <item.icon className="h-6 w-6 text-foreground" />
                  </div>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-6">
                    <div
                      className={`p-6 rounded-xl bg-gradient-to-br ${layer.color}`}
                    >
