...
const contributionTypes = [
  {
    ...
    description:
      "Education, skill development, and knowledge sharing are verified and rewarded. The learn-to-earn model incentivizes continuous learning.",
  ...
  },
  {
    ...
    title: "Work Proofs",
    description:
      "Productive work, whether formal employment or community contribution, is verified and fairly compensated.",
  ...
  },
  {
    ...
    title: "Health Proofs",
    description:
      "Health maintenance, preventive care, and wellness activities contribute to individual and community well-being.",
  ...
  },
  {
    ...
    description:
      "Community service, civic engagement, and participation in governance are recognized and rewarded.",
...
const greenScoringProofs = [
  {
    ...
    description:
      "Households and businesses using solar, wind, or other renewable sources receive sustainability bonuses.",
  },
  {
    title: "Low Carbon Footprint",
    description:
      "Transportation choices, consumption patterns, and lifestyle decisions that reduce emissions are rewarded.",
  },
  {
    title: "Sustainable Practices",
    description:
      "Waste reduction, recycling, water conservation, and other environmental practices contribute to green scores.",
  },
  {
    title: "Carbon Offset Activities",
    description:
      "Tree planting, ecosystem restoration, and other carbon-negative activities are verified and rewarded.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-300 mb-8">
              In the Activity-Based Economy, economic value is not extracted
              from ownership or speculation, but created through verified human
              contribution and sustainable practices.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <p className="text-lg text-neutral-300 mb-6">
                Unlike surveillance capitalism, DRP verifies activity through{" "}
                <strong className="text-foreground">proof systems</strong>
                ...
                {[
                  {
                    ...
                    description:
                      "Users submit encrypted proofs of activity (work, learning, community service) that are verified by AI without revealing private details. The proof is cryptographically signed and stored on IPFS.",
                  },
                  {
                    title: "Proof of Status (PoST)",
                    description:
                      "Institutional verification of credentials, education, employment, or status without exposing personal data. Uses zero-knowledge proofs where possible.",
                  },
                  {
                    title: "Blockchain Verification",
                    description:
                      "All proofs are recorded on the blockchain, creating an immutable, auditable record of contribution without surveillance.",
                  },
                  {
                    title: "AI Scoring",
                    description:
                      "Open-source AI algorithms score contributions based on verified proofs, ensuring fairness and transparency without invasive monitoring.",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={item.title}
      ...
      <section className="py-16 bg-white dark:bg-neutral-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-300 mb-8">
              The Activity-Based Economy recognizes multiple forms of valuable
              contribution:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              {contributionTypes.map((type, index) => (
                ...
                >
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br ${type.color} mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-neutral-300">
                Environmental sustainability is directly rewarded in the
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-300">{proof.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                {[
                  ...
                  >
                    <div
                      className={`p-8 rounded-2xl bg-gradient-to-br ${step.color} mb-4`}
                    >
            ...
            <p className="text-center text-lg text-neutral-300 mt-12">
              The Activity-Based Economy creates a transparent, fair loop where
              verified contribution directly translates to economic reward,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Learn how $RIGHTS and $DeRi tokens power the Activity-Based
              Economy
            </p>
            <Link
