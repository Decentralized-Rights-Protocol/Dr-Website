  ...
  return (
    <>
      ...
      <PremiumPage>
        <PremiumHero
          badge="What is DRP"
          title="Infrastructure for verified rights"
          description="DRP connects identity, activity, and governance into one trust layer for institutions building fair, transparent, and future-resilient systems."
        />
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Verifies credentials and reputation signals without exposing
                private data, supporting governance weighting and access
                control.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Uses AI Elders to triage, verify, and explain integrity checks
                so participation becomes audit-ready—not just claimed.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Records verifiable human activity to reward meaningful
                contribution and help allocate resources more equitably.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Evaluates decisions against rights baselines, aiming to protect
                dignity while preserving transparency and accountability.
              </p>
            </article>
          </div>
        </PremiumSection>
        ...
        <PremiumSection
          eyebrow="Entity map"
          title="Core concepts to explore next"
        >
          <nav
            aria-label="DRP definition links"
