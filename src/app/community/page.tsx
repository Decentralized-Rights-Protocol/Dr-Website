...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Join the DRP community of builders, researchers, and rights advocates. Connect on Discord, GitHub, Twitter, and more.",
  canonical: "/community",
});
...
const channels = [
  {
    emoji: "💬",
    title: "Discord",
    desc: "The primary hub for DRP discussion, support, governance debates, and builder coordination.",
  ...
  },
  {
    emoji: "🐙",
    title: "GitHub",
    desc: "Contribute to the protocol. Open issues, review PRs, and help shape the codebase.",
  ...
  },
  {
    emoji: "✕",
    title: "X / Twitter",
    desc: "Follow @De_Rights for protocol updates, announcements, and community highlights.",
    href: "https://twitter.com/De_Rights",
    cta: "Follow @De_Rights",
    color: "#00bfff",
  },
  {
    emoji: "📸",
    title: "Instagram",
    desc: "Visual storytelling about rights infrastructure, the DRP mission, and community impact.",
  ...
  },
  {
    emoji: "💼",
    title: "LinkedIn",
    desc: "Connect professionally. Follow for research papers, partnership news, and ecosystem updates.",
  ...
  },
  {
    emoji: "📧",
    title: "Email",
    desc: "For partnerships, press, research collaborations, and institutional inquiries.",
...
const roles = [
  {
    title: "Builder",
    desc: "Developers integrating DRP into applications, contributing to the codebase, and building ecosystem tools.",
    action: "Read Docs",
    href: "/docs",
  },
  {
    title: "Researcher",
    desc: "Academics, policy analysts, and researchers studying rights infrastructure, post-quantum cryptography, and governance.",
    action: "Read Whitepaper",
    href: "/whitepaper",
  },
  {
    title: "Rights Advocate",
    desc: "Activists, NGOs, and institutions working to bring DRP's verification infrastructure to communities that need it most.",
    action: "Learn About DRP",
    href: "/about",
  },
  {
    title: "Validator / Elder",
    desc: "Node operators and verified contributors who participate in consensus and governance through the Elder Quorum system.",
    action: "View Roadmap",
    href: "/roadmap",
  },
];
  ...
  return (
    <main className="min-h-screen bg-background text-foreground pt-20">
      <section className="max-w-6xl mx-auto px-6 py-20 border-b border-gray-100 dark:border-foreground/5">
        <div className="max-w-2xl">
          ...
          <p className="text-gray-600 dark:text-foreground/50 text-lg leading-relaxed mb-10">
            DRP is a protocol built by its community. Researchers, engineers,
            advocates, and validators worldwide are shaping the infrastructure
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 border-b border-gray-100 dark:border-foreground/5">
        <div className="mb-14">
          <span className="text-xs tracking-[0.3em] uppercase text-[#00e5cc]/70 mb-4 block">
            Connect
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {channels.map((c) => (
            ...
            >
              ...
              <p className="text-gray-500 dark:text-foreground/40 text-sm leading-relaxed mb-6">
                {c.desc}
              </p>
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-gray-100 dark:bg-white/5">
          {roles.map((r, i) => (
            <div key={r.title} className="bg-background p-10">
              <div className="text-xs font-mono text-gray-300 dark:text-foreground/15 mb-5">
              ...
              <Link
                href={r.href}
                className="inline-flex items-center gap-2 text-[#00e5cc] text-sm hover:gap-4 transition-all"
              >
      ...
      <section className="py-24 px-6 text-center bg-gray-50 dark:bg-transparent border-t border-gray-100 dark:border-foreground/5">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 dark:text-foreground/40 mb-10">
            Every contribution — code, research, advocacy — is tracked and
            rewarded through DRP&apos;s proof system.
          </p>
