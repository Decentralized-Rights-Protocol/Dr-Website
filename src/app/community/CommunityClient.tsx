...
const events: CommunityEvent[] = [
  {
    ...
    date: 'June 2025 (TBA)',
    type: 'UN Event',
    description: 'UN Human Rights Council thematic discussion on digital rights, AI governance, and human rights protections.',
  ...
  },
  {
    ...
    date: 'Q4 2025 (TBA)',
    type: 'UN Event',
    description: 'Global multi‑stakeholder forum on public policy issues related to the Internet, digital rights, and governance.',
  ...
  },
  {
    ...
    description: 'Flagship Ethereum developer conference bringing together builders, researchers, and protocol designers.',
  ...
  },
  {
    ...
    date: '2025 (Date TBA)',
    type: 'Blockchain Conference',
    description: 'Conference focused on decentralized web, interoperability, and the future of Web3 infrastructure.',
  ...
  return (
    <PremiumPage>
      ...
      <PremiumSection
        ...
        title="Build for verified rights, not unverifiable influence"
        description="DRP is a human-rights protocol. Community contributions power PoST/PoAT proofs, governance review workflows, and rights-aligned sustainability initiatives."
      >
        <div className="grid gap-4 md:grid-cols-3">
          <article className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-sm text-slate-300">
            <strong className="text-white font-semibold">For builders</strong>
            <div className="mt-1">Integrate proof flows and governance verification.</div>
          </article>
          <article className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-sm text-slate-300">
            <strong className="text-white font-semibold">For institutions</strong>
            <div className="mt-1">Issue verifiable status credentials and audit trails.</div>
          </article>
          <article className="rounded-xl border border-white/10 bg-white/[0.03] p-4 text-sm text-slate-300">
            <strong className="text-white font-semibold">For advocates</strong>
            <div className="mt-1">Help ensure governance stays dignity and rights-first.</div>
          </article>
        </div>
      </PremiumSection>
          ...
          <div className="rounded-3xl border border-cyan-300/20 bg-gradient-to-r from-cyan-300/15 via-blue-300/10 to-amber-300/10 p-8 text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center rounded-xl border border-white/20 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10"
              >
                View GitHub
              </a>
            </div>
