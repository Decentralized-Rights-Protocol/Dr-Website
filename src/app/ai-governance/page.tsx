  ...
  return (
    <>
      ...
      <PremiumPage>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Detects proof anomalies and potential abuse patterns so review
                workflows can focus on what matters.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Helps enforce baselines so proposals can be evaluated against
                dignity, privacy, and sustainability norms.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Produces reviewable outputs that can be audited and used to
                inform human governance discussions.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Final authority remains with transparent governance processes
                that record public rationales.
              </p>
            </article>
          </div>
        </PremiumSection>
        ...
        <PremiumSection
          eyebrow="Related definitions"
          title="Explore the proof and rights pieces"
        >
