...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const urls: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/what-is-drp`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.95,
    },
    {
      url: `${baseUrl}/how-drp-works`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/proof-of-status`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.85,
    },
    {
      url: `${baseUrl}/proof-of-activity`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.85,
    },
    ...
    {
      url: `${baseUrl}/human-rights-blockchain`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/drp-vs-ethereum`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.7,
    },
