    ...
    <main className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="max-w-md w-full border border-gray-100 dark:border-white/8 bg-gray-50 dark:bg-[#0a0a14] p-8">
        ...
        <h1 className="text-xl font-black text-foreground mb-2">
          Share Your DRP Profile
        </h1>
        <p className="text-sm text-gray-500 dark:text-foreground/40 mb-8">
          Share your verified rights status and activity score with the world.
        </p>
        <div className="space-y-3">
          ...
          <a
            href={`https://twitter.com/intent/tweet?text=I'm+verified+on+DRP+%E2%80%94+the+Decentralized+Rights+Protocol.+%23DRP+%23HumanRights&url=${encodeURIComponent(url)}`}
            target="_blank"
          ...
          <Link
            href="/profile"
            className="flex items-center justify-center gap-2 w-full px-4 py-3 text-xs text-gray-400 dark:text-foreground/30 hover:text-[#00e5cc] transition-colors"
          >
