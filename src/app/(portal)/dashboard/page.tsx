  ...
  const stats = [
    {
      ...
      value: metrics?.cards?.verifiedActivities?.toFixed(1) ?? "—",
    ...
    {
      title: "Lessons Done",
      value: String(metrics?.cards?.activeLearners ?? 0),
      icon: <BookOpen className="w-10 h-10" />,
      accent: "#a855f7",
    },
    {
      title: "$DeRi Earned",
      value: metrics?.cards?.deriIssued?.toLocaleString() ?? "0",
