  ...
  return (
    <>
      ...
      <PremiumPage>
            ...
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold text-foreground">
                  1) Verify status (PoST)
                </h3>
              </div>
              <p className="mt-3 text-sm text-slate-300">
                Institutions and participants provide proofs of verified
                credentials. PoST encodes status signals without exposing
                private data.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold text-foreground">
                  2) Record activity (PoAT)
                </h3>
              </div>
              <p className="mt-3 text-sm text-slate-300">
                Participants submit evidence of meaningful contributions. PoAT
                links outcomes to accountable actors and timestamps.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
                ...
                />
                <h3 className="text-lg font-semibold text-foreground">
                  3) Validate integrity (AI Elders)
                </h3>
              </div>
              <p className="mt-3 text-sm text-slate-300">
                AI Elders triage and validate proof quality, detect anomalies,
                and provide explainable review outputs for validators.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              <div className="flex items-center gap-3">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Rights-aligned governance evaluates proposals against dignity
                and sustainability baselines, then records decisions on-chain.
              </p>
            </article>
          </div>
        </PremiumSection>
        ...
        <PremiumSection
          eyebrow="Start learning with the right page"
          title="Jump to the core definitions"
        >
      ...
      <FAQ
        ...
        title="How DRP Answers Common Questions"
        className="pt-0"
      />
    </>
  );
