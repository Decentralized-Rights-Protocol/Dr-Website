  ...
  return (
    <main className="min-h-screen bg-background text-foreground flex items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      <div className="relative max-w-2xl w-full text-center">
        ...
        >
          <div className="text-[9rem] sm:text-[13rem] font-black leading-none text-foreground/[0.03]">
            404
          </div>
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-[9rem] sm:text-[13rem] font-black leading-none text-[#00e5cc]/12">
              404
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-foreground mb-4">
            This page doesn&apos;t exist in the protocol.
          </h1>
          <p className="text-foreground/40 text-base mb-12 max-w-md mx-auto leading-relaxed">
            The route you&apos;re looking for may have moved, been removed, or
            never existed. Every proof needs a valid address — this one
            doesn&apos;t check out.
          </p>
          <div className="mb-12">
            <p className="text-xs tracking-widest uppercase text-foreground/20 mb-5">
              Jump to
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/"
              className="inline-flex items-center justify-center gap-3 px-7 py-4 bg-[#00e5cc] text-background font-bold text-sm tracking-wide hover:bg-foreground hover:text-background transition-all duration-300"
            >
              <ArrowLeft className="w-4 h-4" /> Back to Home
            </Link>
            <Link
              href="/docs"
              className="inline-flex items-center justify-center gap-3 px-7 py-4 border border-foreground/15 text-foreground/55 text-sm hover:text-foreground hover:border-[#00e5cc]/30 transition-all duration-300"
            >
