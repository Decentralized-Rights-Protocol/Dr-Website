...
export const metadata: Metadata = {
  ...
  description:
    "Understand Proof of Status, Proof of Activities, and AI verification in the Decentralized Rights Protocol.",
};
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400">
            DRP uses a revolutionary consensus mechanism combining Proof of
            Status (PoS) and Proof of Activities (PoA) with AI verification to
        ...
        <section className="mb-16">
          <div className="glass rounded-[2rem] p-10 mb-8 border-l-4 border-purple-500">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Proof of Status verifies the identity and standing of participants
              in the DRP network. It ensures that only verified, legitimate
              users can participate in consensus and governance.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700 mb-6">
            ...
            <ul className="space-y-3 text-neutral-600 dark:text-neutral-400">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Users register their identity through a decentralized identity
                  system
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  Status is verified through multiple attestations from trusted
                  sources
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  Status level determines voting power and participation rights
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary-600 dark:text-primary-400 font-bold">
                ...
                <span>
                  Status can be upgraded through demonstrated commitment and
                  activity
                </span>
              </li>
            </ul>
          ...
          <div className="bg-neutral-50 dark:bg-neutral-800 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 bg-white dark:bg-neutral-900 rounded-lg">
                <div className="font-bold text-primary-600 dark:text-primary-400 mb-2">
                  Basic
                </div>
              ...
              <div className="p-4 bg-white dark:bg-neutral-900 rounded-lg">
                <div className="font-bold text-secondary-600 dark:text-secondary-400 mb-2">
                  Verified
                </div>
                <div className="text-sm text-neutral-600 dark:text-neutral-400">
        ...
        <section className="mb-16">
          <div className="glass rounded-[2rem] p-10 mb-8 border-l-4 border-purple-500">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Proof of Activities rewards participants for meaningful
              contributions to the network, including node operation, governance
        ...
        <section className="mb-16">
          <div className="glass rounded-[2rem] p-10 mb-8 border-l-4 border-cyan-500">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Advanced AI systems verify activities, detect fraud, and ensure
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  AI systems analyze patterns in user activities to detect
                  genuine contributions versus automated or fraudulent behavior.
                </p>
              </div>
              <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                <h4 className="font-semibold text-neutral-900 dark:text-foreground mb-2">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Machine learning models identify suspicious patterns, sybil
                  attacks, and attempts to game the system.
                </p>
              </div>
              <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                <h4 className="font-semibold text-neutral-900 dark:text-foreground mb-2">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  AI assigns reputation scores based on consistency, quality,
                  and impact of contributions over time.
                </p>
              </div>
              <div className="p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                <h4 className="font-semibold text-neutral-900 dark:text-foreground mb-2">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Verified users with high reputation scores participate in
                  consensus decisions with weighted voting power.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="bg-neutral-900 rounded-xl p-6 font-mono text-sm text-green-400">
            <div className="space-y-2">
              ...
              <div className="pl-4">
                {" "}
                return status_verified and activity_verified and ai_score &gt;
                threshold
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 p-6 bg-primary-50 dark:bg-primary-900/20 rounded-xl border border-primary-200 dark:border-primary-800">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mb-4">
            Ready to implement consensus in your DRP application? Check out our
