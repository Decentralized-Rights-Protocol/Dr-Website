  ...
  return (
    <div className="py-24 sm:py-32">
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-3">1. Fork the Repository</h3>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-3">2. Clone Your Fork</h3>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-3">3. Create a Branch</h3>
              <div className="bg-neutral-900 rounded-lg p-4 font-mono text-sm">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-3">4. Make Your Changes</h3>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-3">5. Submit a Pull Request</h3>
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-3">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-foreground mb-6">Contribution Guidelines</h2>
          <div className="space-y-4">
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-start gap-3">
                <Code className="h-6 w-6 text-primary-600 dark:text-primary-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-2">Code Style</h3>
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-2">Testing</h3>
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-2">Documentation</h3>
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-foreground mb-6">Pull Request Process</h2>
          <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
            <ol className="space-y-4 text-neutral-600 dark:text-neutral-400">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">1</span>
                <span>Ensure your code follows the project&rsquo;s style guidelines</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">2</span>
                <span>Write clear commit messages describing your changes</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">3</span>
                <span>Ensure all tests pass and add new tests if needed</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">4</span>
                <span>Update documentation to reflect your changes</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">5</span>
        ...
        <div className="mt-12 p-6 bg-primary-50 dark:bg-primary-900/20 rounded-xl border border-primary-200 dark:border-primary-800">
          <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-2">Ready to Contribute?</h3>
