...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to contribute to the Decentralized Rights Protocol project.",
};
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400">
            Thank you for your interest in contributing to the Decentralized
            Rights Protocol! Every contribution helps make DRP better.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-3">
                ...
                >
                  DRP Blockchain repository
                </a>{" "}
                on GitHub to create your own copy.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                Write your code, add tests, and ensure everything works
                correctly.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-3">
                ...
                description of what you&rsquo;ve changed and why.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                    Follow PEP 8 for Python code. Use meaningful variable names,
                    add comments for complex logic, and keep functions focused.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                    Add tests for new features and ensure all existing tests
                    pass. Aim for good test coverage.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                    Update documentation for any changes you make. Include
                    docstrings for new functions and update README if needed.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
            <ol className="space-y-4 text-neutral-600 dark:text-neutral-400">
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">
                  1
                </span>
                <span>
                  Ensure your code follows the project&rsquo;s style guidelines
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-primary-600 text-foreground rounded-full flex items-center justify-center text-sm font-semibold">
