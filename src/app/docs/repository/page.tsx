...
export const metadata: Metadata = {
  ...
  description:
    "Explore the DRP Blockchain codebase structure and organization.",
};
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-400">
            Understand the organization of the DRP Blockchain codebase and where
            to find key components.
          </p>
        </div>
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 text-foreground mb-6">
            ...
            <p className="text-primary-100 text-lg">
              The DRP Blockchain repository is organized into logical modules
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                Lists all Python dependencies required to run the DRP node.
                Install with{" "}
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                Main project documentation including setup instructions,
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                Entry point for running a DRP node. Handles initialization, peer
                connections, and consensus participation.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-2">
                Implements Proof of Status and Proof of Activity consensus
                mechanisms with AI verification.
              </p>
            </div>
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-foreground mb-2">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-2">
                Post-quantum cryptographic implementations using CRYSTALS-Kyber
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-2">
                AI Elder implementations for verification, fraud detection, and
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-6 border border-neutral-200 dark:border-neutral-700">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-2">
                P2P networking layer for node communication and blockchain
                synchronization.
              </p>
            </div>
          </div>
