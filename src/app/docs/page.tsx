...
export default function DocsPage() {
  return (
    <>
          ...
          {docSections.map((section) => (
            ...
            >
              <div className="flex items-center gap-x-4 mb-4">
                ...
                <h3 className="text-lg font-semibold text-foreground transition-colors group-hover:text-cyan-100">
                  {section.title}
                </h3>
              </div>
      ...
      <PremiumSection
        eyebrow="Support and Contributions"
        title="Build and Improve with the Community"
      >
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="rounded-2xl border border-foreground/10 bg-black/25 p-8">
            ...
            <p className="mb-6 text-slate-300">
              Join our community channels and use the FAQ for rapid answers.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
                href="/community"
                className="inline-flex items-center rounded-lg border border-cyan-300/40 bg-cyan-300/90 px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-cyan-200"
              >
                Join Community
              </Link>
              <Link
                href="/docs/faq"
                className="inline-flex items-center rounded-lg border border-white/20 bg-white/10 px-4 py-2 text-sm font-semibold text-foreground transition hover:bg-white/20"
              >
                View FAQ
              </Link>
            </div>
          ...
          <div className="rounded-2xl border border-foreground/10 bg-black/25 p-8">
            ...
            <p className="mb-6 text-slate-300">
              Help improve docs and developer onboarding quality.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link
