...
export default function LegacyLessonClientPage({
  lessonId,
}: {
  lessonId: string;
}) {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground p-8">
        <h1 className="text-4xl font-black mb-6">
          Protocol Fragment Not Found
        </h1>
        <p className="text-drp-gray mb-10 text-center max-w-md">
          The educational module you are seeking is either restricted or moved
          in the protocol hierarchy.
        </p>
        <Link
          href="/learn"
          className="px-8 py-4 rounded-2xl bg-foreground text-background font-bold hover:bg-drp-cyan transition-all"
        >
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-6">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-3">
                <IconRenderer
                  name="BookOpen"
                  className="h-5 w-5 text-drp-gray"
                />
                <span className="text-[10px] font-cinematic text-drp-gray uppercase tracking-[0.3em] truncate">
                  Academy Module · {lessonId.replace(/-/g, " ")}
                </span>
              </div>
              <span className="text-[10px] font-bold text-drp-cyan uppercase tracking-widest">
                {completed ? "100% Verified" : "Reading Session"}
              </span>
            </div>
          ...
          <div className="hidden md:flex items-center gap-6 shrink-0">
            <div className="flex flex-col items-end">
              ...
              <span className="text-[8px] font-cinematic text-amber-400/40 uppercase tracking-widest">
                Rewards
              </span>
            </div>
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="text-[8px] font-cinematic text-drp-cyan/40 uppercase tracking-widest">
                Experience
              </span>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-drp-gray max-w-3xl mx-auto leading-relaxed font-medium">
            {lesson.description ||
              "Master this module to strengthen your protocol governance weight and understanding."}
          </p>
        </motion.div>
        ...
        {!completed ? (
          ...
          >
            ...
            <p className="text-drp-gray text-lg mb-10 max-w-xl mx-auto">
              You have completed the reading for this curriculum module. Rewards
              have been allocated to your profile.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              <div className="text-center">
                ...
                <div className="text-[10px] font-cinematic text-amber-400/40 uppercase tracking-widest mt-1">
                  $DeRi Tokens
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-[10px] font-cinematic text-drp-cyan/40 uppercase tracking-widest mt-1">
                  Steward XP
                </div>
              </div>
            </div>
        ...
        <div className="mt-32 pt-12 border-t border-foreground/5 flex items-center justify-between">
          ...
          >
            ...
            <div className="text-left">
              <div className="text-[8px] font-cinematic uppercase tracking-widest opacity-40">
                Academy
              </div>
          ...
          <div className="text-right">
            ...
            <div className="text-[10px] font-mono text-drp-cyan/40">
              {lessonId.slice(0, 16)}...
            </div>
          </div>
        </div>
