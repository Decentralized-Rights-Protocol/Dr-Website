...
export const metadata = {
  title: "Refund and Cancellation Policy | Decentralized Rights Protocol",
  description: "DRP refund, cancellation, blockchain transaction, and consumer protection policy.",
};

export default function RefundPolicyPage() {
  const content = readFileSync(join(process.cwd(), "legal", "refund-policy.mdx"), "utf-8");
  return (
      ...
      <div className="container mx-auto max-w-4xl px-4">
        <header className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Refund, cancellation, blockchain transaction, and consumer-protection information.
          </p>
        </header>
        ...
        <nav aria-label="Legal pages" className="mt-8 grid gap-3 sm:grid-cols-3">
          ...
          <Link href="/cookie-policy" className="flex items-center gap-2 rounded-lg border p-4 hover:bg-muted">
            <FileText className="h-5 w-5" aria-hidden="true" /> Cookie Policy
          </Link>
        </nav>
      </div>
    </main>
