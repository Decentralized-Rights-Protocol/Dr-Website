...
const faqItems = [
  ...
  {
    question:
      "How does DRP protect privacy while verifying status and activity?",
    answer:
  ...
  return (
    <>
      ...
      <PremiumPage>
        ...
        <PremiumSection
          eyebrow="Entity-first explanation"
          title="Rights are part of the protocol, not a slogan"
        >
          <div className="grid gap-4 md:grid-cols-2">
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Protocol behavior evaluates proposals against dignity and rights
                baselines.
              </p>
            </article>
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                PoST/PoAT turn status and activity into auditable proofs that
            ...
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                AI Elders help validate integrity and summarize risks under
            ...
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
              ...
              <p className="mt-3 text-sm text-slate-300">
                Incentives target sustainable participation and long-term
