        ...
        >
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-5">
              ...
              <p className="mt-2 text-sm text-slate-300">
                Rewards based on meaningful contribution and transparent
                evidence.
              </p>
            </article>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                body: "PoAT and PoST move trust from claims to proofs.",
              },
              {
                icon: Compass,
        ...
        >
          <div className="space-y-3">
            {[
              ...
              <p
                key={line}
                className="rounded-xl border border-foreground/10 bg-white/[0.03] px-4 py-3 text-sm text-slate-300"
              >
                {line}
              </p>
            ))}
          ...
          <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
            <div className="rounded-3xl border border-cyan-300/20 bg-gradient-to-r from-cyan-300/15 via-blue-300/10 to-indigo-300/10 p-8 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-slate-300">
                Move from philosophy to architecture, economics, and governance
                implementation.
              </p>
