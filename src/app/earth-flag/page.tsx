    ...
    <main className="min-h-screen bg-white dark:bg-[#030308] text-gray-900 dark:text-white pt-20">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-white/50 text-xl leading-relaxed mb-6 max-w-lg">
              ...
              <p className="text-gray-500 dark:text-white/40 text-sm leading-relaxed mb-10 max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/about"
                  className="inline-flex items-center gap-2 px-6 py-3 border border-gray-200 dark:border-white/15 text-gray-600 dark:text-white/60 text-sm hover:border-[#00e5cc]/40 hover:text-gray-900 dark:hover:text-white transition-all">
            ...
            <div className="relative">
              ...
              <div className="mt-3 flex items-center justify-between px-1">
                <p className="text-xs text-gray-400 dark:text-white/25">© Oskar Pernefeldt, 2015</p>
                <a href="/ifope/01_FEB2021_IFOPE_LICENSE.pdf" target="_blank" rel="noopener noreferrer"
                  className="text-xs text-gray-400 dark:text-white/25 hover:text-[#00e5cc] transition-colors flex items-center gap-1">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-4">Seven Rings. One World.</h2>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={r.num} className="flex items-center gap-3 p-3 border border-gray-100 dark:border-white/8 bg-gray-50 dark:bg-[#0a0a14]">
                    ...
                    <span className="text-sm text-gray-700 dark:text-white/60 font-medium">{r.desc}</span>
                  </div>
                ))}
              </div>
            </div>
            <div>
              <div className="relative overflow-hidden border border-gray-200 dark:border-white/10 bg-white">
              ...
              <p className="text-xs text-gray-400 dark:text-white/25 mt-2 text-center">Geometric construction — Design by Oskar Pernefeldt, 2015</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-gray-100 dark:border-white/5">
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="flex items-center gap-2 mb-10">
            ...
            <h2 className="text-xs font-bold tracking-widest uppercase text-gray-400 dark:text-white/30">The Flag in the World</h2>
          </div>
            ...
            {[
              ...
              <div key={photo.src} className="group overflow-hidden border border-gray-100 dark:border-white/8">
                ...
                <div className="p-3 bg-gray-50 dark:bg-[#0a0a14]">
                  <p className="text-xs text-gray-500 dark:text-white/35 leading-relaxed">{photo.caption}</p>
                </div>
              </div>
            ))}
          </div>
          <p className="mt-6 text-xs text-gray-400 dark:text-white/20 text-center">
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="border border-[#00e5cc]/20 bg-[#00e5cc]/5 p-8">
              ...
              <h3 className="text-xl font-black text-gray-900 dark:text-white mb-3">About Oskar Pernefeldt</h3>
              <p className="text-gray-500 dark:text-white/40 text-sm leading-relaxed mb-4">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        <div className="border border-gray-100 dark:border-white/8 bg-gray-50 dark:bg-[#0a0a14] p-6">
          <h4 className="text-xs font-bold tracking-widest uppercase text-gray-400 dark:text-white/25 mb-3">Full Attribution</h4>
          <p className="text-sm text-gray-600 dark:text-white/50 leading-relaxed">
            <strong className="text-gray-900 dark:text-white">International Flag of Planet Earth</strong> — designed by Oskar Pernefeldt, 2015.
