      ...
      >
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            <article key={layer.title} className="rounded-2xl border border-foreground/10 bg-black/30 p-5">
              <Layers className="h-5 w-5 text-cyan-200" />
              <h3 className="mt-3 text-lg font-semibold text-foreground">{layer.title}</h3>
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ...
            <article key={role.title} className="rounded-2xl border border-foreground/10 bg-black/30 p-5">
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
            ...
            <h3 className="mt-3 text-lg font-semibold text-foreground">$DeRi Utility Circuit</h3>
          ...
          <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
            ...
            <h3 className="mt-3 text-lg font-semibold text-foreground">$RIGHTS Governance Circuit</h3>
            <p className="mt-2 text-sm text-slate-300">
      ...
      <section className="pb-20 pt-8">
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
          <div className="rounded-3xl border border-cyan-300/20 bg-gradient-to-r from-cyan-300/15 via-blue-300/10 to-indigo-300/10 p-8 text-center">
            <h2 className="text-3xl font-semibold text-foreground">Explore the Full Architecture in Detail</h2>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <Link href="/whitepaper" className="inline-flex items-center rounded-xl border border-white/20 bg-white/5 px-5 py-3 text-sm font-semibold text-foreground transition hover:bg-white/10">
                Open Whitepaper
