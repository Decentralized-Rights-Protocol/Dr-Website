          ...
          {[
            {
              ...
              body: "Human-facing apps for identity, contribution, and governance interaction.",
            },
            {
              title: "Protocol Layer",
              body: "Rules and standards governing rights-aware transaction semantics.",
            },
            {
              title: "Consensus Layer",
              body: "PoST and PoAT mechanisms validating participation and trust.",
            },
            {
              title: "Network Layer",
              body: "Validator and communication infrastructure securing global operations.",
            },
          ].map((layer) => (
            <article
              key={layer.title}
              className="rounded-2xl border border-foreground/10 bg-black/30 p-5"
            >
          ...
          {[
            {
              icon: Wrench,
              title: "Builders",
              body: "Create applications and infrastructure on top of DRP primitives.",
            },
            {
              icon: Users,
              title: "Communities",
              body: "Coordinate participation, education, and grassroots adoption.",
            },
            {
              icon: Landmark,
              title: "Institutions",
              body: "Integrate DRP rails for trustworthy, transparent operations.",
            },
            {
              icon: ShieldCheck,
              title: "Validators",
              body: "Secure consensus and ensure high-integrity network behavior.",
            },
          ].map((role) => (
            <article
              key={role.title}
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
            ...
            <h3 className="mt-3 text-lg font-semibold text-foreground">
              $DeRi Utility Circuit
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Used for ecosystem participation, activity-linked flows, and
              practical protocol interactions.
            </p>
          </article>
          <article className="rounded-2xl border border-foreground/10 bg-white/[0.03] p-6">
            <Landmark className="h-5 w-5 text-cyan-200" />
            <h3 className="mt-3 text-lg font-semibold text-foreground">
              $RIGHTS Governance Circuit
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Enables governance voice, protocol stewardship, and long-horizon
              network decision alignment.
            </p>
          </article>
        </div>
      </PremiumSection>
        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
          <div className="rounded-3xl border border-cyan-300/20 bg-gradient-to-r from-cyan-300/15 via-blue-300/10 to-indigo-300/10 p-8 text-center">
            <h2 className="text-3xl font-semibold text-foreground">
              Explore the Full Architecture in Detail
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-300">
              Continue into economics, roadmap, and whitepaper pages for
