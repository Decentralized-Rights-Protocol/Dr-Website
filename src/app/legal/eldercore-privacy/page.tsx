...
export const metadata = {
  ...
  description:
    "Privacy Policy for the ElderCore Discord bot and how data is handled.",
  openGraph: {
    title: "ElderCore Privacy Policy | DRP",
    description:
      "Privacy Policy for the ElderCore Discord bot and how data is handled.",
...
export default function EldercorePrivacyPage() {
  const content = readFileSync(
    join(process.cwd(), "legal", "eldercore-privacy.mdx"),
    "utf-8",
  );
  return (
    <div
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <section className="mb-10 text-center">
          ...
          <p className="mt-3 text-neutral-700 dark:text-neutral-300 max-w-2xl mx-auto">
            How ElderCore handles data within Discord servers in line with
