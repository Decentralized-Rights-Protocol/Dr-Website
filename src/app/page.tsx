...
export const metadata = buildPageMetadata({
  ...
  description:
    'DRP is a blockchain protocol that verifies human activity, attests identity, and enables fair resource distribution — starting with Ghana, built for the world.',
  canonical: '/',
