...
const drpAdvantages = [
  {
    ...
    description:
      "Built with artificial intelligence at its core, not as an afterthought",
  ...
  },
  {
    ...
    description:
      "Designed specifically to protect and advance human rights globally",
    color: "text-pink-500",
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    description:
      "Dynamic TPS scaling based on network demand and AI optimization",
    color: "text-yellow-500",
  },
];

export function WhyDRPClient() {
  ...
  return (
    <PremiumPage>
      ...
      <PremiumSection
        ...
        title="DRP is human-rights blockchain infrastructure"
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <article className="rounded-xl border border-foreground/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-foreground">
              PoST verifies identity and status
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Credential proofs and reputation signals for governance weighting.
            </p>
          </article>
          <article className="rounded-xl border border-foreground/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-foreground">
              PoAT verifies meaningful activity
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Evidence of real contribution to support rewards and equitable
              participation.
            </p>
          </article>
          <article className="rounded-xl border border-foreground/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-foreground">
              AI Elders validate integrity
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              An explainable review layer for anomalies and proof quality.
            </p>
          </article>
          <article className="rounded-xl border border-foreground/10 bg-white/[0.03] p-5">
            <h3 className="text-base font-semibold text-foreground">
              Governance is rights-aligned
            </h3>
            <p className="mt-2 text-sm text-slate-300">
              Decisions are evaluated against dignity and sustainability
              baselines.
            </p>
          </article>
        </div>
      ...
      <PremiumSection
        eyebrow="Protocol Edge"
        title="What Makes DRP Structurally Different"
      >
        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
          <div className="rounded-3xl border border-cyan-300/20 bg-gradient-to-r from-cyan-300/15 via-blue-300/10 to-amber-300/10 p-8 text-center">
            <h2 className="text-3xl font-semibold text-foreground">
              Ready to Build on the Future Stack?
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-300">
              Dive into the whitepaper and learning modules to understand DRP
