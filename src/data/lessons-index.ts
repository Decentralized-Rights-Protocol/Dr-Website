...
export const PATHS = [
  ...
  { id: 2, name: 'DRP Core Protocol', icon: '⚡', color: '#7c3aed', lessons: ['drp-architecture','activity-proofs','post-poat-consensus','elder-quorum-system'] },
