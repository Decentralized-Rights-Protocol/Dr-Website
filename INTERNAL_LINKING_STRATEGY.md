# Internal Linking Strategy for DRP Website

## Overview

This document outlines the internal linking strategy to optimize SEO, improve user experience, and enhance AI discoverability.
...
- "RIGHTS token" → /economics/tokenomics
- "decentralized governance" → /economics/governance
...
- "Proof of Status" → /learn or /economics/governance
- "RIGHTS token governance" → /economics/governance
...
- "Proof of Activity" → /learn or /economics/abe
...
- "RIGHTS token" → /economics/tokenomics
- "DeRi token" → /economics/tokenomics
...
- Link to: /whitepaper, /docs, /learn

---

## 4. Contextual Linking Guidelines
...
- Providing additional context or resources
...
- Link is redundant or unnecessary

### 4.2 Contextual Link Examples

**Example 1: PoST Mention**
"DRP uses Proof of Status (PoST) for identity verification without surveillance. [Link: Proof of Status mechanism] This ensures that status emerges from verifiable behavior rather than authority."

**Example 2: Governance Reference**
"DRP governance enables decentralized decision-making through RIGHTS tokens. [Link: DRP governance model] All stakeholders can participate in protocol decisions through transparent, on-chain voting."

**Example 3: Economic Model**
"DRP implements a Sustainable Rights Economy (SRE) that ties value to verified human activity. [Link: DRP economics] This ensures economic rewards align with human rights principles."
...
**Limit:** 3-5 links above the fold
...
**Limit:** 2-3 links per paragraph, 5-7 per section
...
**Limit:** 3-5 links per CTA section

---

## 6. Link Distribution by Page

### 6.1 Homepage Link Distribution

**Navigation:** 5-7 links
**Hero Section:** 2-3 links
**Features Section:** 4-6 links
**Mission Section:** 2-3 links
**FAQ Section:** 3-5 links
**Footer:** 10-15 links

**Total:** 26-39 links

### 6.2 Philosophy Page Link Distribution

**Navigation:** 5-7 links
**Content Sections:** 8-12 links
**Footer:** 10-15 links

**Total:** 23-34 links

### 6.3 Whitepaper Page Link Distribution

**Navigation:** 5-7 links
**Content Sections:** 10-15 links
**Footer:** 10-15 links

**Total:** 25-37 links

### 6.4 Governance Page Link Distribution
...
- Links don't distract from content
...
- Redirected links properly handled
...
### 10.3 AI Discoverability Metrics

- Concept linking accuracy
- Related page associations
